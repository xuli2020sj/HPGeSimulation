...
G4VPhysicalVolume *DetectorConstruction::ConstructPbShield(G4LogicalVolume *motherLogicalVolume)
{
	...
	G4VSolid *Shield_Fe_tubs = new G4Tubs("Shield_Fe_tubs", Shield_Tubs_rmin, Shield_Fe_Tubs_rMax, Shield_Fe_Tubs_dz,
										  Shield_Tubs_sphi, Shield_Tubs_dphi);
	G4LogicalVolume *Shield_Fe_log = new G4LogicalVolume(Shield_Fe_tubs, Shield_Fe, "Shield_Fe_log", 0, 0, 0);
	...
	G4VisAttributes *Shield_Fe_logVisAtt = new G4VisAttributes(G4Colour(1.0, 0.0, 1.0));
	...
	G4VSolid *Shield_Pb_tubs = new G4Tubs("Shield_Pb_tubs", Shield_Tubs_rmin, Shield_Pb_Tubs_rMax, Shield_Pb_Tubs_dz,
										  Shield_Tubs_sphi, Shield_Tubs_dphi);
	G4LogicalVolume *Shield_Pb_log = new G4LogicalVolume(Shield_Pb_tubs, Shield_Pb, "Shield_Pb_log", 0, 0, 0);
	// G4VPhysicalVolume * tracker_phys =
	new G4PVPlacement(0, G4ThreeVector(), Shield_Pb_log, "Shield_Pb_phys",
					  Shield_Fe_log, false, 0, fCheckOverlaps);
	G4VisAttributes *Shield_Pb_logVisAtt = new G4VisAttributes(G4Colour(1.0, 0.0, 0.50));
	...
	G4VSolid *Shield_Sn_tubs = new G4Tubs("Shield_Sn_tubs", Shield_Tubs_rmin, Shield_Sn_Tubs_rMax, Shield_Sn_Tubs_dz,
										  Shield_Tubs_sphi, Shield_Tubs_dphi);
	G4LogicalVolume *Shield_Sn_log = new G4LogicalVolume(Shield_Sn_tubs, Shield_Sn, "Shield_Sn_log", 0, 0, 0);
	// G4VPhysicalVolume * tracker_phys =
	new G4PVPlacement(0, G4ThreeVector(), Shield_Sn_log, "Shield_Sn_phys",
					  Shield_Pb_log, false, 0, fCheckOverlaps);
	G4VisAttributes *Shield_Sn_logVisAtt = new G4VisAttributes(G4Colour(1.0, 0.0, 0.30));
	...
	G4VSolid *Shield_Cu_tubs = new G4Tubs("Shield_Cu_tubs", Shield_Tubs_rmin, Shield_Cu_Tubs_rMax, Shield_Cu_Tubs_dz,
										  Shield_Tubs_sphi, Shield_Tubs_dphi);
	G4LogicalVolume *Shield_Cu_log = new G4LogicalVolume(Shield_Cu_tubs, Shield_Cu, "Shield_Cu_log", 0, 0, 0);
	// G4VPhysicalVolume * tracker_phys =
	new G4PVPlacement(0, G4ThreeVector(), Shield_Cu_log, "Shield_Cu_phys",
					  Shield_Sn_log, false, 0, fCheckOverlaps);
	G4VisAttributes *Shield_Cu_logVisAtt = new G4VisAttributes(G4Colour(1.0, 0.50, 0.60));
	...
	G4VSolid *Shield_Air_tubs = new G4Tubs("Shield_Air_tubs", Shield_Tubs_rmin, Shield_Air_Tubs_rMax, Shield_Air_Tubs_dz,
										   Shield_Tubs_sphi, Shield_Tubs_dphi);
	G4LogicalVolume *Shield_Air_log = new G4LogicalVolume(Shield_Air_tubs, Shield_Air, "Shield_Air", 0, 0, 0);
	...
	G4VisAttributes *Shield_Air_logVisAtt = new G4VisAttributes(G4Colour(1.0, 0.3, 1.0));
...
void DetectorConstruction::ConstructSample(G4LogicalVolume *motherLogicalVolume)
{
	...
	G4VSolid *sampleShape = new G4Tubs("sampleShape", 0. * cm, shapeRad, shapeHalfDepth,
									   0. * deg, 360. * deg);
	G4LogicalVolume *logSample = new G4LogicalVolume(sampleShape, sampleMaterial, "sample_log", 0, 0, 0);

	//	G4VPhysicalVolume * physiWorldPbShield =
	new G4PVPlacement(0, G4ThreeVector(0., 0., sampleMove + shapeHalfDepth), logSample, "sample_phys",
					  motherLogicalVolume, false, 0, fCheckOverlaps);

	G4VisAttributes *visAttSample = new G4VisAttributes(G4Colour(0.3, 0.2, 1.0));
...
void DetectorConstruction::ConstructCollimator(G4LogicalVolume *motherLogicalVolume)
{
	...
	G4VSolid *collimator1 = new G4Tubs("collimator1", 0. * cm, outerRadius, collimatorHalfLength,
									   0. * deg, 360. * deg);
	G4VSolid *collimator2 = new G4Cons("collimator2", 0. * mm, holeRadiusMin, 0. * mm, holeRadiusMax, holeHalfLength,
									   0. * deg, 360. * deg);
	...
	G4LogicalVolume *logCollimator = new G4LogicalVolume(collimator, lead, "collimator_log", 0, 0, 0);
